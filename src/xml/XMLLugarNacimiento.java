...
public class XMLLugarNacimiento extends DefaultHandler{
	...
	private void parseDocument() {
		...
		try {
			...
			sp.parse("lugarnacimiento.xml", this);
	...
	public String printData(){
		...
		//System.out.println("No of ciudades '" + misApellidos.size() + "'.");
                String apellido="Caqueta";
		Random aleatorio;
	...
	public static void main(String[] args){
		XMLLugarNacimiento spe = new XMLLugarNacimiento();
		spe.runExample();
	}
