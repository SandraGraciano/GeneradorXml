...
public class XMLNombreCrisis extends DefaultHandler{
	...
	private void parseDocument() {
		...
		try {
			...
			sp.parse("nombresCrisis.xml", this);
	...
	public String printData(){
		...
		//System.out.println("No of Crisis '" + misApellidos.size() + "'.");
                String apellido="Crisis fronteriza con Venezuela";
		Random aleatorio;
	...
	public static void main(String[] args){
		XMLNombreCrisis spe = new XMLNombreCrisis();
		spe.runExample();
	}
