...
public class XMLTipoCrisis extends DefaultHandler{
	...
	public String printData(){
		...
		//System.out.println("No of Tipos '" + misApellidos.size() + "'.");
	...
	public static void main(String[] args){
		XMLTipoCrisis spe = new XMLTipoCrisis();
		spe.runExample();
	}
